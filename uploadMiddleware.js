...
/* ── Single cleanup campaign image upload ──────────────────────────────── */
const uploadCampaignImage = multer({ storage, fileFilter, limits }).single('image');

module.exports = { uploadScrapPhoto, uploadCraftPhotos, uploadCampaignImage };

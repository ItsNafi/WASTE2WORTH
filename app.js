...
app.get('/dashboard/heat-map',     verifyToken, serveView('heatMap.html'));
...
app.get('/certificates', verifyToken, serveView('certificates.html'));
app.get('/certificates/verify/:certificateId', serveView('verify.html'));
